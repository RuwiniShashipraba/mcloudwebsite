     ...
     <tbody> 
			...
			<?php
				...
				if(isset($_POST['search'])){
					...
					$sql = "SELECT * FROM patient_medical WHERE Email = '".$_SESSION['SESSION_EMAIL']."' AND CONCAT(`Date_for_this_treatment`,`Doctor_name`,`Medical_description_of_patient`,`Medicine_for_this_visit`,`Next_visit_and_reports_required`) LIKE  '%".$search_value."%'";

					$result = mysqli_query($conn,$sql);
	
				}else{
									
					$sql = "SELECT * FROM patient_medical WHERE Email = '".$_SESSION['SESSION_EMAIL']."'";
